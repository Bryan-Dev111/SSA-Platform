...
export const PAGE_DEFINITIONS = [
  ...
  { key: 'GlobalSupplyDashboard', label: 'Global Supply Dashboard', path: '/global-vendors/dashboard' },
...
export const DEFAULT_API_PAGE_ROLES: Record<string, string[]> = {
  ...
  GlobalSupplyBuyerRelationships: ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer'],
