...
import carRootCauseCodesRoutes from './routes/car-root-cause-codes';
...
import managementDirectoryRoutes from './routes/management-directory';
import sourcingDirectorStaffRoutes from './routes/sourcing-director-staff';
...
app.use('/car-root-cause-codes', carRootCauseCodesRoutes);
...
app.use('/management-directory', managementDirectoryRoutes);
app.use('/sourcing-director-staff', sourcingDirectorStaffRoutes);
...
app.use('/banking-settings', bankingSettingsRoutes);
