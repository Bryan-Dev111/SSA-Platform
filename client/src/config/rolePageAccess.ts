...
export const PATH_ROLES: Record<string, string[]> = {
  ...
  '/global-vendors/buyer-relationships': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer'],
  '/global-vendors/internal-management': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer'],
