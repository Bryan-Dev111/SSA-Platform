...
export const PATH_ROLES: Record<string, string[]> = {
  ...
  '/product-hub': ['Admin'],
  '/global-vendors': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/dashboard': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/farm-dashboard': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/farmers': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/farm-profile': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/approved': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/map': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/relationship': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/buyer-relationships': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  ...
  '/global-vendors/logistics': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/logistics-profile': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
  '/global-vendors/expenses': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer', 'CommodityBuyer', 'SourcingDirector'],
