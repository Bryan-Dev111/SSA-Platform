...
export const PATH_ROLES: Record<string, string[]> = {
  ...
  '/global-vendors/dashboard': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer'],
  ...
  '/global-vendors/processing-quality': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer'],
  ...
  '/global-vendors/logistics': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer'],
  '/global-vendors/logistics-profile': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer'],
  '/global-vendors/expenses': ['Admin', 'Viewer', 'QualityEngineer', 'QualityManager', 'Buyer'],
...
const SIDEBAR_PATH_ORDER = [
  ...
  '/global-vendors/processing-quality',
  ...
  '/global-vendors/logistics-profile',
  '/global-vendors/expenses',
