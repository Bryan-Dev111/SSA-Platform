...
export function formatDisplayCalendarDate(value: string | null | undefined, locale = getDocumentLocale()): string {
...
export function formatDisplayDateTime(iso: string | null | undefined, locale = getDocumentLocale()): string {
...
export function formatDisplayCalendarRange(popStart: string | null, popEnd: string | null, locale = getDocumentLocale()): string {
