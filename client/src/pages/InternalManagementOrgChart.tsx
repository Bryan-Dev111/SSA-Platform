/**
 * Visual map of Internal Management areas; buttons switch to the matching tab.
 */
...
type OrgGroup = {
  title: string;
  subtitle?: string;
  items: { label: string; tab: InternalManagementTab }[];
};
    ...
    <div className="card" style={{ marginBottom: '1rem' }}>
      <div className="card-body">
        ...
        <p style={{ marginTop: 0, marginBottom: '1.25rem', fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)' }}>
          Overview of Internal Management areas. Select a box to open that tab.
        </p>
